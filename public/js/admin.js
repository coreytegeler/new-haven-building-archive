...
(function() {
  var $main, addCheckbox, addImage, addQuickCreates, askToDelete, closeQuickCreate, getData, openQuickCreate, openSelect, quickCreate, updateSelectValue, updateTemplate;
  ...
  openQuickCreate = function(event) {
    var $button, $module, $quickCreate, type;
    $button = $(event.target);
  ...
  quickCreate = function(event) {
    var $form, $quickCreate, caption, contentType, data, image, postUrl, processData, type;
