...
(function() {
  window.initPublic = function() {
    var $body, $buildingTiles, $buildings, $glossarySect, $grid, $gridWrap, $indexSect, $infoSect, $main, $searchSect, $side, $singleSect, buildingMapSetup, centerGrid, clickBuilding, clickFilter, clickMarker, clickToggle, closeSide, filter, filterQuery, filterUrl, getContent, getParam, getParams, hoverBuilding, infoMapSetup, insertMap, makeDraggable, nextSlide, openSide, paginate, popState, resizeGrid, selectBuilding, setUp, setUpSlider, tourMapSetup, unhoverBuilding, updateSingleSect, urlQuery;
    $body = $('body');
    $main = $('main');
    $side = $('aside');
    $gridWrap = $('.gridWrap');
    ...
    tourMapSetup = function() {
      var $map, $mapWrap, $section, geocoder;
      geocoder = new google.maps.Geocoder();
