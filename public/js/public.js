...
(function() {
  $(function() {
    var $body, $buildingTiles, $buildings, $buildingsMap, $buildingsWrap, $glossarySect, $indexSect, $infoSect, $main, $searchSect, $side, $singleSect, centerMap, clickBuilding, clickFilter, closeSide, constrainArray, filter, getContent, hoverBuilding, initPublic, insertMap, insertStreetView, makeDraggable, openSide, panelMapSetUp, resizeMap, selectBuilding, switchSection, unhoverBuilding, updateSingleSect;
    $body = $('body');
    $main = $('main');
    $side = $('aside');
