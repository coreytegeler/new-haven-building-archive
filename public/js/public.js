...
(function() {
  $(function() {
    var $body, $buildings, $buildingsMap, $buildingsWrap, $glossarySect, $indexSect, $infoSect, $main, $searchSect, $side, $singleSect, addTourList, centerMap, clickBuilding, closeSide, constrainArray, getContent, hoverBuilding, initPublic, insertMap, insertStreetView, makeDraggable, openSide, panelMapSetUp, resizeMap, selectBuilding, switchSection, unhoverBuilding, updatePanelSection;
    $body = $('body');
    $main = $('main');
    $side = $('aside');
