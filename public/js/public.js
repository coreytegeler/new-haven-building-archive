...
(function() {
  window.initPublic = function() {
    var $body, $buildingTiles, $buildings, $glossarySect, $grid, $gridWrap, $indexSect, $infoSect, $main, $searchSect, $side, $singleSect, buildingMapSetup, centerGrid, clickBuilding, clickFilter, clickMarker, clickToggle, closeSide, filter, filterQuery, filterUrl, getContent, getQuery, hoverBuilding, infoMapSetup, insertMap, makeDraggable, nextSlide, openSide, paginate, popState, resizeGrid, selectBuilding, setUp, setUpSlider, tourMapSetup, unhoverBuilding, updateSingleSect, urlQuery;
    $body = $('body');
    $main = $('main');
    $side = $('aside');
    $gridWrap = $('.gridWrap');
