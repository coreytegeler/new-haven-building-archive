...
(function() {
  $(function() {
    var $body, $buildingTiles, $buildings, $glossarySect, $grid, $gridWrap, $indexSect, $infoSect, $main, $searchSect, $side, $singleSect, centerGrid, clickBuilding, clickFilter, clickToggle, closeSide, constrainArray, filter, filterQuery, getContent, getQuery, hoverBuilding, initPublic, insertMap, makeDraggable, nextSlide, openSide, panelMapSetUp, popState, resizeGrid, selectBuilding, setUpSlider, unhoverBuilding, updateSingleSect;
    $body = $('body');
    $main = $('main');
    $side = $('aside');
    $gridWrap = $('.gridWrap');
